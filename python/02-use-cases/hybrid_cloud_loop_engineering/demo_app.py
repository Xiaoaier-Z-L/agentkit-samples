...
app = FastAPI(title="AgentKit Hybrid Cloud Loop Engineering Demo")
app.add_middleware(
    CORSMiddleware,
...
def agent_card() -> dict[str, object]:
    return {
        "name": "hybrid-cloud-loop-engineering",
        "description": "Bounded plan-act-observe-review loop on AgentKit hybrid cloud",
        "url": "/a2a",
        "version": "0.3.0",
...
async def mcp_endpoint(request: Request) -> dict[str, object]:
    ...
    if method == "initialize":
        result = {
            ...
            "capabilities": {"tools": {}},
            "serverInfo": {"name": "hybrid-loop-engineering", "version": "0.3.0"},
        }
